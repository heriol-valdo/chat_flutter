...
import 'package:flutter_firebase/chat/models/chat_params.dart';
 ...
 // final UsernameCurrent usernameCurrent=UsernameCurrent();
  ...
  void saveDiscusions(){
   ...
   databaseDiscussions.getDocument(chatParams.peer.uid);
    databaseDiscussions.saveDiscusions(chatParams.peer.uid, chatParams.peer.name,chatParams.peer.photo);
  }
